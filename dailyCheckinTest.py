...
checkin('hi3',os.environ['USER_1_TOKEN'],os.environ['USER_1_ID']) 
checkin('gi',os.environ['USER_1_TOKEN'],os.environ['USER_1_ID']) 
checkin('hsr',os.environ['USER_1_TOKEN'],os.environ['USER_1_ID'])
checkin('zzz',os.environ['USER_1_TOKEN'],os.environ['USER_1_ID'])  
checkin('hi3',os.environ['USER_2_TOKEN'],os.environ['USER_2_ID'])
checkin('hsr',os.environ['USER_2_TOKEN'],os.environ['USER_2_ID'])
checkin('gi',os.environ['USER_2_TOKEN'],os.environ['USER_2_ID'])
checkin('zzz',os.environ['USER_2_TOKEN'],os.environ['USER_2_ID'])
checkin('hsr',os.environ['USER_3_TOKEN'],os.environ['USER_3_ID'])
checkin('gi',os.environ['USER_4_TOKEN'],os.environ['USER_4_ID'])
checkin('zzz',os.environ['USER_4_TOKEN'],os.environ['USER_4_ID'])
